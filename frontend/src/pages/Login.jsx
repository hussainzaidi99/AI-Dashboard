        ...
        <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 transition-colors duration-500 overflow-hidden relative">
            ...
            >
                <div className="text-center space-y-3">
                    ...
                    <h1 className="text-4xl font-black font-heading tracking-tight text-foreground mb-2">Welcome Back</h1>
                    <p className="text-muted-foreground font-medium">Sign in to your AI Intelligence Dashboard</p>
                </div>
