        ...
        <div className="min-h-screen flex items-center justify-center p-6">
            ...
            >
                <div className="text-center space-y-3">
                    ...
                    <h1 className="text-4xl font-black font-heading tracking-tight text-white mb-2">Create Account</h1>
                    <p className="text-zinc-500 font-medium">Start your journey with AI-driven analytics</p>
                </div>
